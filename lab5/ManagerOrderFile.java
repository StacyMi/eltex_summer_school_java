...
public class ManagerOrderFile extends AManageOrder {
    ...
    public Orders readAll() {
        ...
        try {
            ObjectInputStream in = new ObjectInputStream(new FileInputStream("/home/anastasia/IdeaProjects/lab2/src/file_all.bin"));
            try {
    ...
    public void saveAll(Orders orders) {
        ...
        try {
            ObjectOutputStream out = new ObjectOutputStream(
                    new FileOutputStream("/home/anastasia/IdeaProjects/lab2/src/file_all.bin"));
            try {
