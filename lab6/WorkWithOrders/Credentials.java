...
public class Credentials implements Serializable {
  ...
  public Credentials(){
    ...
    transient private static String[] AllLastname = {"Петров", "Иванов", "Сидоров"};
    transient private static String[] AllFirstname = {"Игорь", "Иван", "Андрей"};
    transient private static String[] AllPatronomic = {"Николаевич", "Сергеевич", "Валерьевич"};
    transient private static String[] AlleMail = {"frendsD@ya.ru", "GoodH@gmail.com", "pop49@icloud.com"};
